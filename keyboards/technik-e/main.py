...
# keymap
keyboard.keymap = [[KC.RGB_TOG, KC.A, KC.E, KC.R, KC.T, KC.Y, KC.U, KC.I, KC.O, KC.L, KC.A, KC.S, KC.D, KC.F, KC.G, KC.H, KC.J, KC.K, KC.L, KC.L, KC.L, KC.X, KC.C, KC.V, KC.B, KC.N, KC.M, KC.H, KC.DOT, KC.L, KC.LALT, KC.L, KC.LCTRL, KC.NO, KC.L, KC.SLASH, KC.TAB, KC.RCTRL, KC.NO], 
